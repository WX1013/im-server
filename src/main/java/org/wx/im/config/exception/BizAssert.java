...
import static org.wx.im.config.exception.BaseException.BASE_VALID_PARAM;
...
public final class BizAssert {
    ...
    public static void fail(BaseException exceptionCode) {
     ...
     * @
     */
    public static void isTrue(boolean condition, BaseException exceptionCode) {
        if (!condition) {
            fail(exceptionCode);
        }
    }
     ...
     * @
     */
    public static void notNull(Object object, BaseException exceptionCode) {
        if (object == null) {
            fail(exceptionCode);
        }
    }
     ...
     * @
     */
    public static void isNull(Object object, BaseException exceptionCode) {
        if (object != null) {
            fail(exceptionCode);
        }
    }
     ...
     * @
     */
    public static void notEmpty(Collection<?> collection, BaseException exceptionCode) {
    ...
    public static <T> void notEmpty(T[] array, BaseException exceptionCode) {
     ...
     * @
     */
    public static void notBlank(String value, BaseException exceptionCode) {
        if (value == null || value.isEmpty()) {
            fail(exceptionCode);
        }
    }

    public static void notBlank(String value, String exceptionMsg) {
        if (value == null || value.isEmpty()) {
            fail(exceptionMsg);
        }
    }
     ...
     * @
     */
    public static void notEquals(Object unexpected, Object actual, BaseException exceptionCode) {
     ...
     * @
     */
    public static void equals(String expected, String actual, BaseException exceptionCode) {
