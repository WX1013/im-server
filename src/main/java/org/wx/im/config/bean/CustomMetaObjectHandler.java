...
public class CustomMetaObjectHandler implements MetaObjectHandler {
    ...
    public CustomMetaObjectHandler(long workerId, long dataCenterId) {
        super();
    ...
    private void created(MetaObject metaObject) {
        ...
        if (entity.getCreateTime() == null) {
            this.setFieldValByName(SuperEntity.CREATE_TIME_FILED, LocalDateTime.now(), metaObject);
        }
        if (entity.getCreateUser() == null) {
            // TODO 获取当前用户
            this.setFieldValByName(SuperEntity.CREATE_USER_FILED, 0L, metaObject);
        }
    }
    ...
    private void update(MetaObject metaObject) {
        ...
        if (entity.getUpdateUser() == null) {
            // TODO 获取当前用户
            this.setFieldValByName(SuperEntity.UPDATE_USER_FILED, 0L, metaObject);
        }
        this.setFieldValByName(SuperEntity.UPDATE_TIME_FILED, LocalDateTime.now(), metaObject);
    }
